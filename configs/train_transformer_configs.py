...
conv9_emb256_layer2_extended_ptbxl = {'modelname':'conv9_emb256_layer2', "annotate":"_extended_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[6,7], "train_impute_extended":300}}

conv9_emb256_layer2_packet_ptbxl = {'modelname':'conv9_emb256_layer2', "annotate":"_packet_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[0,1],  "train_impute_wind":5, "train_impute_prob":.30}}


bdc883_emb256_layer2_extended_ptbxl = {'modelname':'bdc883_emb256_layer2', "annotate":"_extended_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[0,1,2], "train_impute_extended":300}}

bdc883_emb256_layer2_packet_ptbxl = {'modelname':'bdc883_emb256_layer2', "annotate":"_packet_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[3,4,5],  "train_impute_wind":5, "train_impute_prob":.30}}


van_emb256_posembed_layer2_packet_ptbxl = {'modelname':'van_emb256_posembed_layer2', "annotate":"_packet_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1,  "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[2,3], "train_impute_wind":5, "train_impute_prob":.30}}

van_emb256_posembed_layer2_extended_ptbxl = {'modelname':'van_emb256_posembed_layer2', "annotate":"_extended_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[0,1], "train_impute_extended":300}}



deepmvi_extended_ptbxl = {'modelname':'deepmvi', "annotate":"_extended_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 64, "gpus":[0], "train_impute_extended":300}}

deepmvi_transient_ptbxl = {'modelname':'deepmvi', "annotate":"_transient_ptbxl_pool12", 'modeltype':'transformer', 
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
