...
from models.BaseModel_Wrapper import BaseModelWrapper

class transformer(BaseModelWrapper):
    def __init__(self, modelname, data_type, train_data=None, val_data=None, 
        ...
        model_module = __import__(f'models.TransformerModel_Architecture.{modelname}', fromlist=[""])
