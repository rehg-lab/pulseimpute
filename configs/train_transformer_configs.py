...
bdc883_emb256_layer2_extended_ptbxl_2 = {'modelname':'bdc883_emb256_layer2', "annotate":"_extended_ptbxl_2", 'modeltype':'transformer',
            "data_name":"ptbxl","data_load": {"mode":True, "bounds":1, "channels":[0]},
            "modelparams":{"max_len":1000},
            "train":{"bs": 2, "gpus":[0], "train_impute_extended":300}}

bdc883_emb256_layer2_mimic_ppg_2 = {'modelname':'bdc883_emb256_layer2', "annotate":"_mimic_ppg_2", 'modeltype':'transformer',
            "data_name":"mimic_ppg","data_load": {"mean":True, "bounds":1},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "bs": 2, "gpus":[0], "train_realppg":True}}
