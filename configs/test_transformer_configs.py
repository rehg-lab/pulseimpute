...
conv9_emb256_layer2_ppg_test = {'modelname':'conv9_emb256_layer2', "annotate":"_mimic_ppg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            ...
            "train":{"iter_save":100, "reload_epoch_long":60000,"bs": 4, "gpus":[0,1,2,3]}}

van_emb256_posembed_layer2_ppg_test = {'modelname':'van_emb256_posembed_layer2', "annotate":"_mimic_ppg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            "data_name":"mimic_ppg","data_load": {"addmissing":True, "mean":True, "bounds":1, "train":False, "val":False, "test":True},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":45200,"bs": 4, "gpus":[0,1,2,3]}}

bdc883_emb256_layer2_ppg_test = {'modelname':'bdc883_emb256_layer2', "annotate":"_mimic_ppg", 'modeltype':'transformer', 
             "annotate_test":"_test",
            "data_name":"mimic_ppg","data_load": {"addmissing":True, "mean":True, "bounds":1, "train":False, "val":False, "test":True},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":54200,"bs": 4, "gpus":[0,1,2,3]}}
...
bdc883_emb256_layer2_mimic_ecg_test= {'modelname':'bdc883_emb256_layer2', "annotate":"_mimic_ecg", 'modeltype':'transformer', 
            ...
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":47000,"bs": 4, "gpus":[0,1,2,3]}}
...
van_emb256_posembed_layer2_mimic_ecg_test = {'modelname':'van_emb256_posembed_layer2', "annotate":"_mimic_ecg", 'modeltype':'transformer', 
            ...
            "data_name":"mimic_ecg","data_load": {"train":False, "val":False, "test":True, "addmissing":True},
            "modelparams":{"convertolong":{"attention_window":[800,800], "attention_dilation":[4,4] }},
            "train":{"iter_save":100, "reload_epoch_long":41000,"bs": 4, "gpus":[0,1,2,3]}}
